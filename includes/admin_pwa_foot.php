...
<span id="adminPwaBannerBody">تیکت جدید، پاسخ کاربر و یادآوری برای همه ادمین‌ها؛ ثبت‌نام جدید فقط برای سوپرادمین.</span>
</div>
...
(function(){
    ...
    function showBanner(mode){
        ...
        if(mode === 'install'){
            ...
            bodyEl.textContent = 'تیکت جدید، پاسخ کاربر و یادآوری برای همه ادمین‌ها؛ ثبت‌نام جدید فقط برای سوپرادمین.';
